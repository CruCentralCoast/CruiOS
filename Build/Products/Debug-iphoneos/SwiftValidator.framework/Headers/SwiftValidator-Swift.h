...
SWIFT_PROTOCOL("_TtP14SwiftValidator18ValidationDelegate_")
...
///
/// \param textField UITextField that holds textField.
///
/// \param errorMessage String that holds error message.
///
/// \returns  An initialized object, or nil if an object could not be created for some reason that would not result in an exception.
- (nonnull instancetype)initWithTextField:(UITextField * _Nonnull)textField error:(NSString * _Nonnull)error OBJC_DESIGNATED_INITIALIZER;

/// Initializes ValidationError object with a textField, errorLabel, and errorMessage.
///
/// \param textField UITextField that holds textField.
///
/// \param errorLabel UILabel that holds error label.
///
/// \param errorMessage String that holds error message.
///
/// \returns  An initialized object, or nil if an object could not be created for some reason that would not result in an exception.
- (nonnull instancetype)initWithTextField:(UITextField * _Nonnull)textField errorLabel:(UILabel * _Nullable)errorLabel error:(NSString * _Nonnull)error OBJC_DESIGNATED_INITIALIZER;
@end
